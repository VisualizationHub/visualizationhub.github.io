function zoomInCharts(options) {
    ...
    var chart = c3.generate({
        bindto: '#datasetComparsionPopupContent',
        data: {
            x: 'x',
            columns: [
...
$(function() {
    ...
    $(".js-closeDatasetComparsionPopup").click(function() {
        console.log("**closeDatasetComparsionPopup POPUP closed");
        // Hide pop up of zoom charts
